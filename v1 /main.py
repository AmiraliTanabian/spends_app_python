...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.TabWidget.setGeometry(QtCore.QRect(270, 0, 551, 750))
        ...
        self.line.setGeometry(QtCore.QRect(250, 0, 31, 641))
        ...
        self.info_icon.setGeometry(QtCore.QRect(230, 200, 66, 19))
        ...
        self.category_icon.setGeometry(QtCore.QRect(230, 230, 66, 19))
        ...
        self.add_icon_lbl.setGeometry(QtCore.QRect(200, 100, 91, 61))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 551, 373))
        ...
        self.line_2 = QtWidgets.QFrame(parent=self.FirstTab)
        self.line_2.setGeometry(QtCore.QRect(350, 380, 20, 201))
        ...
        self.line_3.setGeometry(QtCore.QRect(-10, 160, 561, 16))
    ...
    def showByFilter(self):
        # if index == 0 -- > App is startup dont do anythig
        if self.index != 0 :
